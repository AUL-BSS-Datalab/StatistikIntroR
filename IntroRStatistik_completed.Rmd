...
bagvedlingende lag - selve 'computeren/lommeregneren'. Tredje vinue
(øverst til høje) viser blandt andet det enviroment vi arbejder i, når
vi har lavet et projekt. Et enviroment skal her forstås som en oversigt
over de variable vi bruger i vores kode (objekter). Vi bruger blandt
...
pakker udvider basesfunktionaliteten, og gør det blandt andet muligt at
...
i en variabel. Vi kalder vores variabel noget beskrivende og
...
Man kan nu se, at variablerne er i vores enviroment (vinduet øverst til
...
stemmer fordelt på de partier, der blev valgt ind i Folketinget i år
2019. Vi bruger følgende funktioner:
...
I nedenstående visualisering definerer vi følgende parametre: - Fitrerer
at vi kun er interesserede i år 2019 - Vi laver en visualisering i
ggplot - X aksen består af parti rangeret efter, at flest stemmer er
øverst og mindst stemmer er nederst - y aksen består af antal stemmer -
fill/fyldfarven skal relatere sig til antallet af stemmer -
Visualiseringen skal være et søjlediagram - Vi bytter om på placeringen
af x og y aksen, da det så er nemmere at aflæse visualiseringen - Vi
giver labels/navne til x og y aksen - Vi anvender en farveskala fra
ggplot, der gør det nemmere at aflæse visualiseringen
...
tidligere. Den eneste nye tilføjelse er funtionen factor(). Denne gør
...
Vi ønsker at sammelægge de to datasæt vi indlæste i starten af scriptet;
...
forhåbenligt til at give mening med eksemplet nedenfor.
